          ...
          <?php if (isset($_SESSION["id_user"]) && !empty($_SESSION["id_user"])) { ?>
            ...
            <td style="display:none" class="table002 action">
              ...
              <span class="eliminacion float-right ml-n6">
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" class="eliminar btn btn-outline-danger " title="Eliminar Link" href="?c=link&m=delete&id=<?php echo $row->id_link_PK; ?>" name="eliminar_nota"><i class="fas fa-trash-alt"></i></a>
              </span>
