         ...
         <?php if(isset($_SESSION["id_user"]) || !empty($_SESSION["id_user"])){ ?>
          ...
          <?php } } ?>
            <span <?php echo !isset($_SESSION["id_user"]) ? "style=\"display:none\"" : ""; ?> >
               <a id="hab_elim" href="" class="btn btn-default pull-right"   title="Habilitar eliminacion de notas"  value="1"><i class="fas fa-trash-alt"></i></a>|
            </span>
            <span <?php echo !isset($_SESSION["id_user"]) ? "style=\"display:none\"" : ""; ?> >
                <a  id="hab_actu" href="?c=auth&m=on_update" class="btn btn-default pull-right" title="Habilitar Modificacion" ><i class="fas fa-edit"></i></a>|
            </span>
