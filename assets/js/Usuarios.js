  window.onload = function() {
      ...
      document.getElementById("form_change_pass").addEventListener("submit", validacionChangePass);
                  ...
                  if (ajax.readyState == 4) {
                      ...
                      if (ajax.status == 200) {
                          if (ajax.responseText === "true") {
                              showAlert("success", "La contraseña ha sido actualidada correctamente.");
